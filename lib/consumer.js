...
var PrivateKey = require('bch-lib').PrivateKey;
var PublicKey = require('bch-lib').PublicKey;
var Address = require('bch-lib').Address;
 ...
 *
 * @param {bch.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {bch.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {bch.Transaction} the updated transaction
 */
