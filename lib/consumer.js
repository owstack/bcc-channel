...
var $ = require('bcccore-lib').util.preconditions;

var Script = require('bcccore-lib').Script;
var Networks = require('bcccore-lib').Networks;
var PrivateKey = require('bcccore-lib').PrivateKey;
var PublicKey = require('bcccore-lib').PublicKey;
var Address = require('bcccore-lib').Address;
var _ = require('bcccore-lib').deps._;
 ...
 *
 * @param {bcccore.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {bcccore.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {bcccore.Transaction} the updated transaction
 */
