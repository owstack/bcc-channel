...
var $ = require('bcc-lib').util.preconditions;

var Script = require('bcc-lib').Script;
var Networks = require('bcc-lib').Networks;
var PrivateKey = require('bcc-lib').PrivateKey;
var PublicKey = require('bcc-lib').PublicKey;
var Address = require('bcc-lib').Address;
var _ = require('bcc-lib').deps._;
 ...
 *
 * @param {bcc.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {bcc.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {bcc.Transaction} the updated transaction
 */
