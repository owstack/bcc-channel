...
var $ = require('@owstack/bch-lib').util.preconditions;

var Script = require('@owstack/bch-lib').Script;
var Networks = require('@owstack/bch-lib').Networks;
var PrivateKey = require('@owstack/bch-lib').PrivateKey;
var PublicKey = require('@owstack/bch-lib').PublicKey;
var Address = require('@owstack/bch-lib').Address;
var _ = require('@owstack/bch-lib').deps._;
 ...
 *
 * @param {PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {PrivateKey=} opts.fundingKey - key to use for funding the channel
...
Consumer.prototype.setupRefund = function() {
  ...
  console.log(multisigOut, this.refundAddress, this.refundTx.inputAmount);
