# Payment Channels
Bcccore includes classes necessary to handle payment channel smart contracts. The approach taken is networking-agnostic, so this library can be used at any layer.
...
```
npm install bcccore-channel --save
```

For client-side projects:

```
bower install bcccore-channel --save
```
...
```javascript
var Consumer = require('bcccore-channel').Consumer;
...
```javascript
var Provider = require('bcccore-channel').Provider;
